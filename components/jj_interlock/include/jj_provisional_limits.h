...
// These are conservative, uncharacterized Phase-0/Phase-1 placeholders, not
...
#define JJ_PROVISIONAL_AUTO_CHAMBER_TARGET_C  50.0f
#define JJ_PROVISIONAL_PRINTER_STALE_MS       12000U
